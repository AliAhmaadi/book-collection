...
<title><?php echo $title ?> - Collect Laptops</title>
    ...
    <div class="container">
      <div class="table-container">
        ...
        <div class="col-table-cell col-lg-6 col-md-6 col-sm-12 col-xs-12 inner">
          <div id="logo"><a href="/"><img class="img-responsive" src="/assets/image/logo.png" title="MarketShop" alt="MarketShop" /></a></div>
        </div>
        <!-- Logo End -->
        <!-- Search Start-->
        <div class="col-table-cell col-lg-3 col-md-3 col-sm-6 col-xs-12 inner">
          ...
          <div id="search" class="input-group">
            <input id="s" type="text" name="s" value="" placeholder="Search" class="form-control input-lg" />
