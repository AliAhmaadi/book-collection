                    ...
                    <div class="grid-body no-border">
                      ...
                      <div class="row column-seperation">
                        <div class="col-md-6">
                          ...
                          <div class="row form-row">
                            <div class="col-md-12">
                              <input name="confirm_password" id="confirm_password" type="password"  class="form-control <?php echo form_error('confirm_password') ? 'error' : NULL; ?>" placeholder="Confirm Password">
