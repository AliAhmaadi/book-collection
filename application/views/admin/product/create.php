              ...
              <div class="row column-seperation">
                <div class="col-md-6">
                  <h4>Basic Information</h4>            
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <select name="brand_id" id="brand_id" class="form-control <?php echo form_error('brand_id') ? 'error' : NULL; ?>">
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="code" id="code" type="text"  class="form-control <?php echo form_error('code') ? 'error' : NULL; ?>" placeholder="Code" value="<?php echo set_value('code'); ?>">
                        <?php echo form_error('code', '<div class="alert alert-danger">', '</div>'); ?>
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="product_condition" id="product_condition" type="text"  class="form-control <?php echo form_error('product_condition') ? 'error' : NULL; ?>" placeholder="Condition" value="<?php echo set_value('product_condition'); ?>">
                        <?php echo form_error('product_condition', '<div class="alert alert-danger">', '</div>'); ?>
                      </div>
                    </div>  
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="price" id="price" type="text"  class="form-control <?php echo form_error('price') ? 'error' : NULL; ?>" placeholder="Price" value="<?php echo set_value('price'); ?>">
