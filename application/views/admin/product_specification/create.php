              ...
              <div class="row column-seperation">
                <div class="col-md-6">
                  <h4>Basic Information</h4>            
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="processor_speed" id="processor_speed" type="text"  class="form-control <?php echo form_error('processory_speed') ? 'error' : NULL; ?>" placeholder="Processor Speed" value="<?php echo set_value('processor_speed'); ?>">
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="installed_ram" id="installed_ram" type="text"  class="form-control <?php echo form_error('install_ram') ? 'error' : NULL; ?>" placeholder="Installed Ram" value="<?php echo set_value('installed_ram'); ?>">
                        <?php echo form_error('installed_ram', '<div class="alert alert-danger">', '</div>'); ?>
                      </div>
                    </div>  
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="screen_size" id="screen_size" type="text"  class="form-control <?php echo form_error('screen_size') ? 'error' : NULL; ?>" placeholder="Screen Size" value="<?php echo set_value('screen_size'); ?>">
                        <?php echo form_error('screen_size', '<div class="alert alert-danger">', '</div>'); ?>
                      </div>
                    </div>
