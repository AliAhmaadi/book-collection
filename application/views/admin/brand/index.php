        ...
        <div class="col-md-14">
            <div class="grid simple ">
                <div class="grid-body no-border">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a id="activeAllStatus" href="#" class="btn btn-primary tip" data-toggle="tooltip" title="Active Selected"><i class="fa fa-eye"></i></a>
                            <a id="deactiveAllStatus" href="#" class="btn btn-primary tip" data-toggle="tooltip" title="Deactive Selected"><i class="fa fa-eye-slash"></i></a>
                            <a id="deleteAll" href="#" class="btn btn-primary tip" data-toggle="tooltip" title="Delete Selected"><i class="fa fa-trash"></i></a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <img src="/uploads/<?php echo $brand->brand_img ?>" width="80" height="80" class="img-thumbnail" alt="$brand->title">
                                        <?php endif ?>
                                    </td>
                                    <td>
